// Knowledge OS — Knowledge Graph view (Phase 2 preview)
...
export default function KnowledgeGraph({ layout = 'force', onOpen }) {
  ...
  const isRealDoc = selNode && docs.some((d) => d.id === selNode.id);
  ...
  return (
    <div style={{ display: 'flex', height: '100%', minHeight: 0 }}>
      <div ref={wrapRef} onPointerDown={onCanvasDown}
        ...
        <div style={{ position: 'absolute', bottom: 14, left: 14, zIndex: 5, display: 'flex', gap: 14, alignItems: 'center', padding: '7px 12px', background: 'var(--surface-primary)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-md)' }}>
